...
export default function Landing() {
  ...
  useEffect(() => {
    connectSocket.on("status", (status) => {
      alert(status);
    });
  }, []);
  ...
  useEffect(() => {
    if (emitFlag) {
      ...
      connectSocket.once("match found", (e) => {
  ...
  useEffect(() => {
    if (game.success) {
      connectSocket.emit("playerJoinsGame", {
        gameId: gameIdInput,
      });
    }
  }, [game]);
  ...
  const sendConfig = async (token) => {
    ...
    if (create.success === true) {
      ...
      connectSocket.emit("createNewGame", tuid, obj);
    }
  };
  ...
  const cancelGame = async () => {
    ...
    if (remove.success === true) {
      connectSocket.emit("removeGame", gameIdInput);
      setOpenDialog(false);
      setGameIdInput("");
            ...
            <ModalWrapper>
              {maskedLoader ? (
                ...
                <>
                      ...
                      <>
                        ...
                        <span>
                          <img
                            style={{ width: "18px" }}
                            src={
                              "data:image/png;base64,"
                            }
                          ></img>
                        </span>
                      </>
                  ...
                  <Loader />
                  <br />
                  <Button variant="outlined" onClick={() => cancelGame()}>
                    Cancel Game
                  </Button>
                </>
              ) : (
              ...
              {startFlag ? (
                ...
                <>
                  ...
                  <p style={{ textAlign: "center", fontSize: "1.5rem" }}>
                    ...
                    <p style={{ textAlign: "center", fontSize: "0.8rem" }}>
                      {" "}
                      This tx is irreversible, {"you'll"} lose if you quit game.
                    </p>
          ...
          <Box sx={style}>
            ...
            <ModalWrapper>
              ...
              >
                ...
                />
                <br />
                <Button variant="outlined" onClick={() => sendConfig(token)}>
                  Start Game
                </Button>
              </FormControl>
            </ModalWrapper>
...
const ModalWrapper = styled.div`
  ...
  .css-19mk8g1-MuiInputBase-root-MuiFilledInput-root:hover:not(
      .Mui-disabled
    ):before {
  ...
  .css-67qocj-MuiInputBase-root-MuiFilledInput-root-MuiSelect-root:hover:not(
      .Mui-disabled
    ):before {
    border-bottom: 1px solid white;
  }
  .css-67qocj-MuiInputBase-root-MuiFilledInput-root-MuiSelect-root:not(
      .Mui-disabled
    ):before {
    border-bottom: 1px solid #b0b0b0;
  }
